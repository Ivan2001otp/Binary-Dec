...
const PreOrderForm = () => {
  ...
  return (
    ...
    className='w-96 bg-blue-900 border-4 border-red-400 rounded-xl mx-auto p-8 relative transition-transform duration-500 hover:scale-110 hover:bg-gray-800'
    >
          <div>
          ...
          className="space-y-4 md:px-4 md:py-4">
            ...
            <div>
              ...
              <input
               type="email" 
               placeholder='david123@mypro.com' 
               id="email" 
              onChange={handleInputChange}
